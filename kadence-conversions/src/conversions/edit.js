 ...
 */
export default function ConversionEditor( {
	attributes,
	setAttributes,
	isSelected,
	context,
	...
	const { previewDevice, currentPostId } = useSelect(
		( select ) => {
			...
			return {
				previewDevice: __experimentalGetPreviewDeviceType ? __experimentalGetPreviewDeviceType() : 'Desktop',
	...
	useEffect( () => {
		...
		const updateIs12HourTime = /a(?!\\)/i.test(
			settings.formats.time
				.toLowerCase() // Test only the lower case a
				.replace( /\\\\/g, '' ) // Replace "//" with empty strings
				.split( '' ).reverse().join( '' ) // Reverse the string and test for "a" not followed by a slash
		);
		setIs12HourTime( updateIs12HourTime );
	...
	useEffect( () => {
		...
		} else if ( currentPostId && currentPostId !== postID ) {
			setAttributes( {
				postID: currentPostId,
			} );
		}
	...
	const previewPaddingTop = getPreviewSize( previewDevice, ( undefined !== padding ? padding[ 0 ] : '' ), ( undefined !== paddingTablet ? paddingTablet[ 0 ] : '' ), ( undefined !== paddingMobile ? paddingMobile[ 0 ] : '' ) );
	const previewPaddingRight = getPreviewSize( previewDevice, ( undefined !== padding ? padding[ 1 ] : '' ), ( undefined !== paddingTablet ? paddingTablet[ 1 ] : '' ), ( undefined !== paddingMobile ? paddingMobile[ 1 ] : '' ) );
	const previewPaddingBottom = getPreviewSize( previewDevice, ( undefined !== padding ? padding[ 2 ] : '' ), ( undefined !== paddingTablet ? paddingTablet[ 2 ] : '' ), ( undefined !== paddingMobile ? paddingMobile[ 2 ] : '' ) );
	const previewPaddingLeft = getPreviewSize( previewDevice, ( undefined !== padding ? padding[ 3 ] : '' ), ( undefined !== paddingTablet ? paddingTablet[ 3 ] : '' ), ( undefined !== paddingMobile ? paddingMobile[ 3 ] : '' ) );
	const previewMarginTop = getPreviewSize( previewDevice, ( undefined !== margin ? margin[ 0 ] : '' ), ( undefined !== marginTablet ? marginTablet[ 0 ] : '' ), ( undefined !== marginMobile ? marginMobile[ 0 ] : '' ) );
	const previewMarginRight = getPreviewSize( previewDevice, ( undefined !== margin ? margin[ 1 ] : '' ), ( undefined !== marginTablet ? marginTablet[ 1 ] : '' ), ( undefined !== marginMobile ? marginMobile[ 1 ] : '' ) );
	const previewMarginBottom = getPreviewSize( previewDevice, ( undefined !== margin ? margin[ 2 ] : '' ), ( undefined !== marginTablet ? marginTablet[ 2 ] : '' ), ( undefined !== marginMobile ? marginMobile[ 2 ] : '' ) );
	const previewMarginLeft = getPreviewSize( previewDevice, ( undefined !== margin ? margin[ 3 ] : '' ), ( undefined !== marginTablet ? marginTablet[ 3 ] : '' ), ( undefined !== marginMobile ? marginMobile[ 3 ] : '' ) );
	// Max width.
	const previewMaxWidth = getPreviewSize( previewDevice, ( undefined !== maxWidth ? maxWidth[ 0 ] : '' ), ( undefined !== maxWidth ? maxWidth[ 1 ] : '' ), ( undefined !== maxWidth ? maxWidth[ 2 ] : '' ) );
	// MinHeight.
	const previewMinHeight = getPreviewSize( previewDevice, ( undefined !== minHeight ?  minHeight[ 0 ] : '' ), ( undefined !==  minHeight ?  minHeight[ 1 ] : '' ), ( undefined !== minHeight ?  minHeight[ 2 ] : '' ) );
	// Border Width.
	const previewBorderTop = getPreviewSize( previewDevice, ( undefined !== borderWidth ? borderWidth[ 0 ] : '' ), ( undefined !== borderWidthTablet ? borderWidthTablet[ 0 ] : '' ), ( undefined !== borderWidthMobile ? borderWidthMobile[ 0 ] : '' ) );
	const previewBorderRight = getPreviewSize( previewDevice, ( undefined !== borderWidth ? borderWidth[ 1 ] : '' ), ( undefined !== borderWidthTablet ? borderWidthTablet[ 1 ] : '' ), ( undefined !== borderWidthMobile ? borderWidthMobile[ 1 ] : '' ) );
	const previewBorderBottom = getPreviewSize( previewDevice, ( undefined !== borderWidth ? borderWidth[ 2 ] : '' ), ( undefined !== borderWidthTablet ? borderWidthTablet[ 2 ] : '' ), ( undefined !== borderWidthMobile ? borderWidthMobile[ 2 ] : '' ) );
	const previewBorderLeft = getPreviewSize( previewDevice, ( undefined !== borderWidth ? borderWidth[ 3 ] : '' ), ( undefined !== borderWidthTablet ? borderWidthTablet[ 3 ] : '' ), ( undefined !== borderWidthMobile ? borderWidthMobile[ 3 ] : '' ) );
	// Border Radius.
	const previewRadiusTop = getPreviewSize( previewDevice, ( undefined !== borderRadius ? borderRadius[ 0 ] : '' ), ( undefined !== borderRadiusTablet ? borderRadiusTablet[ 0 ] : '' ), ( undefined !== borderRadiusMobile ? borderRadiusMobile[ 0 ] : '' ) );
	const previewRadiusRight = getPreviewSize( previewDevice, ( undefined !== borderRadius ? borderRadius[ 1 ] : '' ), ( undefined !== borderRadiusTablet ? borderRadiusTablet[ 1 ] : '' ), ( undefined !== borderRadiusMobile ? borderRadiusMobile[ 1 ] : '' ) );
	const previewRadiusBottom = getPreviewSize( previewDevice, ( undefined !== borderRadius ? borderRadius[ 2 ] : '' ), ( undefined !== borderRadiusTablet ? borderRadiusTablet[ 2 ] : '' ), ( undefined !== borderRadiusMobile ? borderRadiusMobile[ 2 ] : '' ) );
	const previewRadiusLeft = getPreviewSize( previewDevice, ( undefined !== borderRadius ? borderRadius[ 3 ] : '' ), ( undefined !== borderRadiusTablet ? borderRadiusTablet[ 3 ] : '' ), ( undefined !== borderRadiusMobile ? borderRadiusMobile[ 3 ] : '' ) );
	// Width
	//const previewWidth = getPreviewSize( previewDevice, ( undefined !== width ? width[ 0 ] : '' ), ( undefined !== width ? width[ 1 ] : '' ), ( undefined !== width ? width[ 2 ] : '' ) );
	// Close button
	const previewClosePaddingTop = getPreviewSize( previewDevice, ( undefined !== closePadding ? closePadding[ 0 ] : '' ), ( undefined !== closePaddingTablet ? closePaddingTablet[ 0 ] : '' ), ( undefined !== closePaddingMobile ? closePaddingMobile[ 0 ] : '' ) );
	const previewClosePaddingRight = getPreviewSize( previewDevice, ( undefined !== closePadding ? closePadding[ 1 ] : '' ), ( undefined !== closePaddingTablet ? closePaddingTablet[ 1 ] : '' ), ( undefined !== closePaddingMobile ? closePaddingMobile[ 1 ] : '' ) );
	const previewClosePaddingBottom = getPreviewSize( previewDevice, ( undefined !== closePadding ? closePadding[ 2 ] : '' ), ( undefined !== closePaddingTablet ? closePaddingTablet[ 2 ] : '' ), ( undefined !== closePaddingMobile ? closePaddingMobile[ 2 ] : '' ) );
	const previewClosePaddingLeft = getPreviewSize( previewDevice, ( undefined !== closePadding ? closePadding[ 3 ] : '' ), ( undefined !== closePaddingTablet ? closePaddingTablet[ 3 ] : '' ), ( undefined !== closePaddingMobile ? closePaddingMobile[ 3 ] : '' ) );
	const previewCloseSize = getPreviewSize( previewDevice, ( undefined !== closeSize ? closeSize[ 0 ] : '' ), ( undefined !== closeSize ? closeSize[ 1 ] : '' ), ( undefined !== closeSize ? closeSize[ 2 ] : '' ) );
			...
			<TemplateSelect
				...
				onImport={ ( templateName ) => {
					if ( templateName === 'slide_in' ) {
						...
						// Popup Standard.
						setAttributes( { templateSelected: templateName, padding: [0,0,0,0], maxWidth: [ 700, '', '' ], closePosition: 'inside', } );
	...
	return (
		<Fragment>
			<InspectorControls>
					...
					{ conversionTrigger === 'scroll' && (
						<Fragment>
							...
							{ conversionType === 'banner' && (
								<ToggleControl
									label={ __( 'Hide again if scroll up?', 'kadence-conversions' ) }
									checked={ scrollHide }
									onChange={ value => setAttributes( { scrollHide: value } ) }
								/>
							) }
						</Fragment>
					) }
				...
				>
					<DisplaySettings
						...
						placeholder={ ( undefined === meta[ '_kad_conversion_show' ] || '' === meta[ '_kad_conversion_show' ] ) ? __( 'Entire Site', 'kadence-conversions' ) : __( 'None', 'kadence-conversions' ) }
						onChange={ ( value ) => {
							if ( ! value ) {
				...
				{ kadenceConversionsParams.woocommerce && (
					...
					>
						<ToggleControl
							label={ __( 'Only show when cart currency total value is more than.', 'kadence-conversions' ) }
							checked={ requireCartMinimum }
							onChange={ ( value ) => setAttributes( { requireCartMinimum: value } ) }
						/>
						{ requireCartMinimum && (
							<SingleRangeControl
								label={ __( 'Cart total more than currency value', 'kadence-conversions' ) }
								value={ cartMinimum }
						...
						<ToggleControl
							label={ __( 'Only show when cart currency total value is less than.', 'kadence-conversions' ) }
							checked={ requireCartMaximum }
							onChange={ ( value ) => setAttributes( { requireCartMaximum: value } ) }
						/>
						{ requireCartMaximum && (
							<SingleRangeControl
								label={ __( 'Cart Total less than currency value', 'kadence-conversions' ) }
								value={ cartMaximum }
			...
			<InspectorAdvancedControls>
				<SingleRangeControl
					label={ __( 'Z-Index Control', 'kadence-conversions' ) }
					className="conversions-z-index"
					value={ zindex }
