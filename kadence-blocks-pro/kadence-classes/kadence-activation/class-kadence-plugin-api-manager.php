	...
	class Kadence_Plugin_API_Manager {
		...
		public function is_membership_activated() {
			if ( is_null( self::$memberactive ) ) {
				...
				$membership = true;
				self::$memberkey = 'ktl_wc_order_asdsfasdads_am_2yYBYvwwmuLF';
				self::$memberemail = 'any@gmai.com';
		...
		public function config_page() {
			...
			if ( isset( $_GET['kadence_reset_instance_id'] ) && 'reset' === $_GET['kadence_reset_instance_id'] ) {
				$this->update_setting_option( 'kt_plugin_api_manager_instance_id', 'needs_instance' );
			}
			?>
